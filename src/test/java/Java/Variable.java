...
public class Variable {
     ...
     1. Instance Variables :: Instance variables are non-static variables and are declared in a class outside of any method, constructor, or block.
     *
    ...
    this.geek = "Shubham Jain";
     ...
     /* 3. Static Variables/Class Variable :: These variables are declared similarly to instance variables. The difference is that static variables are declared using the
     ...
     * If we access a static variable without the class name, the compiler will automatically append the class name. But for accessing the static variable of a different class,
     we must mention the class name as 2 different classes might have a static variable with the same name.
    ...
    public static void main(String[] args)
    {
        ...
        // static variable
        System.out.println("Geek Name is : " + Variable.geeky);
    }
